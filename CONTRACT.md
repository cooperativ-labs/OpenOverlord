...
- Per-ticket branch/worktree preparation before local agent spawn when enabled
...
- Read-only derived ticket branch metadata from `branch_prepared` events

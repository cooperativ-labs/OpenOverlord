...
- Project resource registration commands, including `ovld add-cwd`, which accepts optional `--key <resourceKey>` to bind the checkout to a stable logical resource key.

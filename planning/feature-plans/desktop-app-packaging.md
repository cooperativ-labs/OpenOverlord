...
| `ovld` / `overlord` CLI | `open-overlord` packed tarball | `asarUnpack`'d under `Contents/Resources/cli` |
...
**v1 (recommended):** ship the packed `open-overlord` (which already vendors

...
Codex launch prompts should keep the ticket objective compact and pass model and reasoning effort through native Codex flags when configured.

Recommended launch shape:

```bash
codex [--model <model>] [-c model_reasoning_effort="<level>"] "Begin working on this ticket."
```

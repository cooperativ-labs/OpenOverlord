...
| `OVERLORD_DEVICE_LABEL` | Override the human-facing device name for this machine's execution target. Optional; falls back to the hostname. Does not affect the device fingerprint. |

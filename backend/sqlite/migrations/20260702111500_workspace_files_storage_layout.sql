...
SELECT
  lower(hex(randomblob(16))), w.id, bucket_keys.bucket_key, 'local_fs',
  NULL, 'database/.local/storage', '{}',
  NULL, '2026-07-02T11:15:00.000Z', '2026-07-02T11:15:00.000Z', 1
  FROM workspaces w
 CROSS JOIN (
   SELECT 'workspace-images' AS bucket_key
   UNION ALL SELECT 'user-images'

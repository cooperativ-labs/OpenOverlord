      ...
      <div className="px-3">
        <div className="min-w-0">
          ...
          <div className="mt-4 flex items-end justify-between gap-2">
            ...
            <div className="flex min-w-0 max-w-[55%] shrink justify-end gap-2">
              <TicketAssigneeSummary assignee={assignee} />
              {cardState.objectiveCount > 0 ? (
                <div
                  className={cn(
                    'pointer-events-none flex h-5 min-w-5 items-center justify-center rounded-full text-[11px] font-medium tabular-nums text-white',
